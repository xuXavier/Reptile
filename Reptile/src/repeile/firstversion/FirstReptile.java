 ...
 * @Description: 能够实现从单个网页中抓取文字和图片信息
 * @author Xavier Xu
 * @date 2019年4月
 *
 */
public class FirstReptile {
	...
	public static String desGetUrl(String url) {
		...
		try {
			Document doc = Jsoup.connect(url)
					.userAgent("Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; Trident/5.0; MALC)").get();
